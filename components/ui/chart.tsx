    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          const itemConfig = getPayloadConfigFromPayload(config, item, key)
          const itemPayload =
            typeof itemAny === 'object' && itemAny !== null && 'payload' in itemAny
              ? (itemAny.payload as Record<string, unknown> | undefined)
              : undefined
          const indicatorColor =
            ...
            (itemPayload && typeof itemPayload.fill === 'string'
              ? itemPayload.fill
              : undefined) ||
            (typeof itemAny.color === 'string' ? itemAny.color : undefined)

          return (
            <div
              key={String(itemAny.dataKey ?? index)}
              className={cn(
                  ...
                  >
                    ...
                    {itemAny.value && (
                      <span className="text-foreground font-mono font-medium tabular-nums">
                        {String(itemAny.value).toLocaleString()}
                      </span>
                    )}
                  </div>
                </>
